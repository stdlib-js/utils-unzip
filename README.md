...
```javascript
unzip = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-unzip@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/utils-unzip/tags). For example,

```javascript
unzip = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-unzip@v0.2.2-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var unzip = require( 'path/to/vendor/umd/utils-unzip/index.js' )
```
...
[test-image]: https://github.com/stdlib-js/utils-unzip/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/utils-unzip/actions/workflows/test.yml?query=branch:v0.2.2
